...
my $macKey = "AC422D5AE27EDA22";
my $pinKey = "8CEE3C8B012D8B39";
...
}
{
	...
	eval {
		my $data = $p1->Data();
		my $mac=`./crypt.pl "MAC" $macKey $data 16`;
		chomp($mac);
...
#$p4 .= "";
...
# res: 

